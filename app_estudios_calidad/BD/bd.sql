...
CREATE TABLE EstudioAtunes (
    ...
    FOREIGN KEY (idTipoProducto) REFERENCES TipoDeProductos(idTipoProducto),
    FOREIGN KEY (idInfoRelevante) REFERENCES InfoRelevante(idInfoRelevante)
);
...
CREATE TABLE estudiopandecaja (
  ...
  informacionconsumidor tinyint(1) DEFAULT NULL,
...
INSERT INTO EstudioServilletas (idEstudioServilletas, nombreProducto, descripcion, region, precio_paq, precio_10_paq, contenido_neto, calificacion, acabados, Resistencia_servilleta, Absorción_total, observaciones, idtipoproducto) VALUES
...
INSERT INTO estudiotermospersonales (idtermospersonales, nombreProducto, descripcion, capacidad, precio, informacion, calificacion, region, Diseño, Dimensiones, Ensambledelatapa, Verificada, Peso, Hermeticidad, Aguafria, Aguacaliente, observaciones, idtipoproducto) VALUES
